    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          <motion.div
            className="mb-14 relative perspective-[800px]"
            animate={
              transitionStage === "exit"
                ? {
            ...
            transition={{
              ...
              ease: transitionStage === "exit" ? [0.19, 1, 0.22, 1] : "easeInOut",
          ...
          >
            ...
            <div className="relative">
              ...
              <motion.img
                src="/Logo.png"
                alt="Wheelboard Logo"
                className="w-36 h-36 object-contain relative z-10" // Increased from w-24 h-24
                style={{
                  filter:
                    transitionStage === "exit"
          ...
          >
            ...
            <div className="flex justify-between items-center mt-3">
              ...
              <motion.div
                className="text-gray-800 text-sm font-bold bg-white/50 px-2 rounded-full"
                animate={{
        ...
        {transitionStage === "exit" && (
          <>
            <motion.div
              className="absolute inset-0 bg-white z-30 opacity-0"
            ...
            <motion.div
              className="absolute inset-0 bg-gradient-to-b from-white via-transparent to-white z-25 pointer-events-none"
              initial={{ opacity: 0 }}
            ...
            <motion.div
              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full z-15"
              initial={{ opacity: 0 }}
