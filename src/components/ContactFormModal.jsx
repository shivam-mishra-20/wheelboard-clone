            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <input
                  ...
                  required
                  className="px-4 py-3 rounded-lg bg-gray-50 w-full placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#0052CC]"
                />
              </div>
              <div>
                <input
              ...
              <div>
                <textarea
                  ...
                  placeholder="Message"
                  required
                  className="px-4 py-3 rounded-lg bg-gray-50 w-full placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#0052CC] resize-none"
                />
              </div>
              <button
                type="submit"
